...
class TestPackageConan(ConanFile):
    ...
    def requirements(self):
        boost_deps = ['algorithm', 'assert', 'bind', 'config', 'core', 'detail', 'exception', 'function', 'io', 'iterator', 'mpl', 'numeric_conversion', 'optional', 'preprocessor', 'smart_ptr', 'static_assert', 'test', 'timer', 'type_traits', 'utility']
